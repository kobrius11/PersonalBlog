...
import psycopg2
from .personal_blog import local_settings
...
config = {
    "dbname": os.getenv("POSTGRES_DB", local_settings.DB_NAME),
    "user": os.getenv("POSTGRES_USER", local_settings.DB_USER),
    "password": os.getenv("POSTGRES_PASSWORD", local_settings.DB_PASSWORD),
    "host": os.getenv("POSTGRES_HOST", local_settings.DB_HOST),
    "port": os.getenv("POSTGRES_PORT", local_settings.DB_PORT)
}
